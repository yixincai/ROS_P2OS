...
(cl:defmethod cl:initialize-instance :after ((m <PTZState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PTZState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p2os_driver-msg:<PTZState> is deprecated: use p2os_driver-msg:PTZState instead.")))

(cl:ensure-generic-function 'pan-val :lambda-list '(m))
(cl:defmethod pan-val ((m <PTZState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:pan-val is deprecated.  Use p2os_driver-msg:pan instead.")
  (pan m))

(cl:ensure-generic-function 'tilt-val :lambda-list '(m))
(cl:defmethod tilt-val ((m <PTZState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:tilt-val is deprecated.  Use p2os_driver-msg:tilt instead.")
  (tilt m))

(cl:ensure-generic-function 'zoom-val :lambda-list '(m))
(cl:defmethod zoom-val ((m <PTZState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:zoom-val is deprecated.  Use p2os_driver-msg:zoom instead.")
  (zoom m))

(cl:ensure-generic-function 'relative-val :lambda-list '(m))
(cl:defmethod relative-val ((m <PTZState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:relative-val is deprecated.  Use p2os_driver-msg:relative instead.")
  (relative m))
