...
(cl:defmethod cl:initialize-instance :after ((m <BatteryState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BatteryState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p2os_driver-msg:<BatteryState> is deprecated: use p2os_driver-msg:BatteryState instead.")))
...
(cl:defmethod voltage-val ((m <BatteryState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:voltage-val is deprecated.  Use p2os_driver-msg:voltage instead.")
  (voltage m))
