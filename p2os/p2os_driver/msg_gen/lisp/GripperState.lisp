...
(cl:defclass <GripperState> (roslisp-msg-protocol:ros-message)
  ((grip
    :reader grip
    :initarg :grip
    :type p2os_driver-msg:GripState
    :initform (cl:make-instance 'p2os_driver-msg:GripState))
   (lift
    :reader lift
    :initarg :lift
    :type p2os_driver-msg:LiftState
    :initform (cl:make-instance 'p2os_driver-msg:LiftState)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GripperState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GripperState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p2os_driver-msg:<GripperState> is deprecated: use p2os_driver-msg:GripperState instead.")))

(cl:ensure-generic-function 'grip-val :lambda-list '(m))
(cl:defmethod grip-val ((m <GripperState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:grip-val is deprecated.  Use p2os_driver-msg:grip instead.")
  (grip m))

(cl:ensure-generic-function 'lift-val :lambda-list '(m))
(cl:defmethod lift-val ((m <GripperState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:lift-val is deprecated.  Use p2os_driver-msg:lift instead.")
  (lift m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GripperState>)))
  ...
  (cl:format cl:nil "GripState grip~%LiftState lift~%~%================================================================================~%MSG: p2os_driver/GripState~%# direction -1 is inward, +1 is outward, 0 is stationary~%uint32 state~%int32 dir~%bool inner_beam~%bool outer_beam~%bool left_contact~%bool right_contact~%~%================================================================================~%MSG: p2os_driver/LiftState~%# direction -1 is downard, +1 is upward, 0 is stationary~%int32 state~%int32 dir~%float32 position~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GripperState)))
  "Returns full string definition for message of type 'GripperState"
  (cl:format cl:nil "GripState grip~%LiftState lift~%~%================================================================================~%MSG: p2os_driver/GripState~%# direction -1 is inward, +1 is outward, 0 is stationary~%uint32 state~%int32 dir~%bool inner_beam~%bool outer_beam~%bool left_contact~%bool right_contact~%~%================================================================================~%MSG: p2os_driver/LiftState~%# direction -1 is downard, +1 is upward, 0 is stationary~%int32 state~%int32 dir~%float32 position~%~%~%"))
