...
(cl:defmethod cl:initialize-instance :after ((m <MotorState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p2os_driver-msg:<MotorState> is deprecated: use p2os_driver-msg:MotorState instead.")))
