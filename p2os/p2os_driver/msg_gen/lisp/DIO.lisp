...
(cl:defmethod cl:initialize-instance :after ((m <DIO>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DIO)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p2os_driver-msg:<DIO> is deprecated: use p2os_driver-msg:DIO instead.")))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <DIO>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:count-val is deprecated.  Use p2os_driver-msg:count instead.")
  (count m))

(cl:ensure-generic-function 'bits-val :lambda-list '(m))
(cl:defmethod bits-val ((m <DIO>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:bits-val is deprecated.  Use p2os_driver-msg:bits instead.")
  (bits m))
