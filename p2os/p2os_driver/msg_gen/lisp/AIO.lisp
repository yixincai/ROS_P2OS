...
(cl:defmethod cl:initialize-instance :after ((m <AIO>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AIO)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p2os_driver-msg:<AIO> is deprecated: use p2os_driver-msg:AIO instead.")))

(cl:ensure-generic-function 'voltages_count-val :lambda-list '(m))
(cl:defmethod voltages_count-val ((m <AIO>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:voltages_count-val is deprecated.  Use p2os_driver-msg:voltages_count instead.")
  (voltages_count m))

(cl:ensure-generic-function 'voltages-val :lambda-list '(m))
(cl:defmethod voltages-val ((m <AIO>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:voltages-val is deprecated.  Use p2os_driver-msg:voltages instead.")
  (voltages m))
