...
(cl:defmethod cl:initialize-instance :after ((m <LiftState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LiftState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p2os_driver-msg:<LiftState> is deprecated: use p2os_driver-msg:LiftState instead.")))
...
(cl:defmethod position-val ((m <LiftState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:position-val is deprecated.  Use p2os_driver-msg:position instead.")
  (position m))
