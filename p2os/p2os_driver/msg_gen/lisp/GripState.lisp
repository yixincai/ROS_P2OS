...
(cl:defmethod cl:initialize-instance :after ((m <GripState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GripState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p2os_driver-msg:<GripState> is deprecated: use p2os_driver-msg:GripState instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <GripState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:state-val is deprecated.  Use p2os_driver-msg:state instead.")
  (state m))

(cl:ensure-generic-function 'dir-val :lambda-list '(m))
(cl:defmethod dir-val ((m <GripState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:dir-val is deprecated.  Use p2os_driver-msg:dir instead.")
  (dir m))

(cl:ensure-generic-function 'inner_beam-val :lambda-list '(m))
(cl:defmethod inner_beam-val ((m <GripState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:inner_beam-val is deprecated.  Use p2os_driver-msg:inner_beam instead.")
  (inner_beam m))

(cl:ensure-generic-function 'outer_beam-val :lambda-list '(m))
(cl:defmethod outer_beam-val ((m <GripState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:outer_beam-val is deprecated.  Use p2os_driver-msg:outer_beam instead.")
  (outer_beam m))

(cl:ensure-generic-function 'left_contact-val :lambda-list '(m))
(cl:defmethod left_contact-val ((m <GripState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:left_contact-val is deprecated.  Use p2os_driver-msg:left_contact instead.")
  (left_contact m))

(cl:ensure-generic-function 'right_contact-val :lambda-list '(m))
(cl:defmethod right_contact-val ((m <GripState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:right_contact-val is deprecated.  Use p2os_driver-msg:right_contact instead.")
  (right_contact m))
